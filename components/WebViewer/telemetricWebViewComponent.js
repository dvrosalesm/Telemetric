      ...
      <View style={styles.WebContainer}>
        <WebView
          ...
          allowingReadAccessToURL={
            'file://' +
            this.props.uri.replace('index.html', '').replace(' ', '%20')
          }
        ...
        <TouchableOpacity
          onPress={() => this.returnToLocalApps()}
          style={styles.OverGestures}>
          <View style={styles.OverGestureContainer}>
            <Image
              style={styles.BackMenuImage}
...
export default connect(MapStateToProps, {getUserDetails, registerData})(
  TelemetricWebView,
);
