...
class localApps extends Component {
  ...
  downloadApp(app) {
    this.props.downloadAppFiles(
      app,
      () => {
        this.onAppDownloadSuccess();
      },
      () => {
        this.onAppDownloadFail();
      },
    );
  }
  ...
  deleteApp(app) {
    ...
    this.props.deleteApp(app, () => {
      AlertMessage(
        'App Eliminada',
        'La aplicación ha sido eliminada correctamente',
        () => {
          this.setState({
            loading: false,
          });
  ...
  cancelAppDownload(app) {
    this.props.cancelAppDownload(app, () => {
      AlertMessage(
        'Descarga cancelada',
        'La descarga se ha cancelado correctamente',
        () => {},
      );
    });
  }
  ...
  onAppDownloadFail(app) {
    AlertMessage(
      'Atención',
      'La descarga del recurso ' +
        app.name +
        ' ha fallado por favor intentar de nuevo.',
    );
  }
  ...
  render() {
    ...
    return (
      <View style={componentStyles.MainContainer}>
        ...
        <Text style={componentStyles.HeaderTitle}> Mis recursos </Text>
        <Apps
          appPackage={this.props.LocalApps}
